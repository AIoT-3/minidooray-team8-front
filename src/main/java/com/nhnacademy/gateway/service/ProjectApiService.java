...
import com.nhnacademy.gateway.dto.task.ProjectDetailDto;
...
public class ProjectApiService {
    ...
    public ProjectApiService(RestTemplate restTemplate, @Value("${minidooray.task-api.url}") String taskApiUrl) {
    ...
    public void addProjectMember(Long projectId, com.nhnacademy.gateway.dto.task.ProjectMemberRequest requestDto) {
