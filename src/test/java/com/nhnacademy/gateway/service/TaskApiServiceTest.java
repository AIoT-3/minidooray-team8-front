...
class TaskApiServiceTest {
    ...
    void setUp() {
        ...
        taskApiService = new TaskApiService(restTemplate, taskApiUrl);
    }
    ...
    void testCreateTask() {
        ...
        when(restTemplate.postForEntity(eq(taskApiUrl + "/projects/" + projectId + "/tasks"), eq(request), eq(TaskDto.class)))
                .thenReturn(ResponseEntity.ok(response));

        TaskDto result = taskApiService.createTask(projectId, request);

        assertEquals("T1", result.title());
        verify(restTemplate).postForEntity(taskApiUrl + "/projects/" + projectId + "/tasks", request, TaskDto.class);
    }
    ...
    void testGetTask() {
        ...
        when(restTemplate.getForEntity(eq(taskApiUrl + "/projects/" + projectId + "/tasks/" + taskId), eq(TaskDetailDto.class)))
                .thenReturn(ResponseEntity.ok(response));

        TaskDetailDto result = taskApiService.getTask(projectId, taskId);

        assertEquals("T1", result.title());
        verify(restTemplate).getForEntity(taskApiUrl + "/projects/" + projectId + "/tasks/" + taskId, TaskDetailDto.class);
    }
    ...
    void testUpdateTask() {
        ...
        when(restTemplate.exchange(
                eq(taskApiUrl + "/projects/" + projectId + "/tasks/" + taskId),
                eq(HttpMethod.PUT),
    ...
    void testDeleteTask() {
        ...
        verify(restTemplate).delete(taskApiUrl + "/projects/" + projectId + "/tasks/" + taskId);
    }
    ...
    void testSetMilestone() {
        ...
        verify(restTemplate).postForEntity(taskApiUrl + "/projects/" + projectId + "/tasks/" + taskId + "/milestones", request, Void.class);
    }
    ...
    void testAddTags() {
        ...
        verify(restTemplate).postForEntity(taskApiUrl + "/projects/" + projectId + "/tasks/" + taskId + "/tags", request, Void.class);
    }
}
